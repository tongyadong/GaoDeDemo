        ...
        public void onWeatherLiveSearched(LocalWeatherLiveResult weatherLiveResult , int rCode) {
            if (rCode == 1000) {
                if (weatherLiveResult != null && weatherLiveResult.getLiveResult() != null) {
                    ...
                    Toast.makeText(WeatherSearchActivity.this, R.string.no_result,Toast.LENGTH_SHORT).show();
                }
            }else {
                Toast.makeText(WeatherSearchActivity.this, rCode,Toast.LENGTH_SHORT).show();
            } 
        }
        /**
         * 天气预报查询结果回调
